...
const batchScoreSchema = z.object({
  topics: z.array(
    z.object({
      ...
      summary: z.string().describe('Short punchy headline — under 80 characters, no filler. This is editorial cartoon copy, not a news wire. DEFAULT RULE: always find the wry, ironic, or humorous angle first. The headline should make someone smirk or lean in, not just inform. Ask: what is the implicit joke or absurdity here? Lead with that. Use colon structure, deadpan reframing, or ironic understatement — "Worldcoin\'s New Turing Test: Coinbase KYC" NOT "Worldcoin Now Uses Coinbase KYC to Distinguish Humans from AI". "Block\'s Automation Strategy: Lay Off the Humans" NOT "Block Lays Off Nearly Half Its Staff, Citing AI Automation". EXCEPTION: if the raw facts are genuinely more striking than any spin (e.g. "Satoshi Was AI From the Future"), report the claim straight — the truth is already the punchline. Drop the "Person Says:" prefix unless the WHO is the story.'),
