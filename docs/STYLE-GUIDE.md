...
Bitcoin symbols must be handled with care. The wrong treatment reads as negative commentary
on Bitcoin itself regardless of intent.
...
### Why This Matters
- A Bitcoin ₿ on fire reads as "Bitcoin is crashing" — not "a developer is debugging"
- A small ₿ logo on a server tower reads as "Bitcoin infrastructure" — subtle and contextual
...
### The 5-Second Test
Can a viewer understand the scene, identify the robots as AIBTC characters,
and get the joke within 5 seconds?

### The Orange Rule
Count the orange elements. If there are more than 4 instances of orange, it's too many.
